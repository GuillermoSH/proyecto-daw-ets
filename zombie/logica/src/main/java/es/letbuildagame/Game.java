...
public class Game extends Canvas implements Runnable {
    ...
    public static final int WIDTH = 640, HEIGHT = WIDTH / 20 * 12;
     ...
     * es llamado repetidamente produce la percepción de ser una película o una animación.)
     */
    public void run() {
     ...
     * el numero de fps que queramos y el uso de la memoria, ademas del color de fondo de la pantalla.
     ...
     * limitaciones de hardware y software determinan si se puede implementar una estrategia de búfer
     * particular y cómo. Estas limitaciones son detectables a través de las
     * capacidades de GraphicsConfiguration utilizadas al crear el Canvas o la Window .")
    */
    private void render() {
